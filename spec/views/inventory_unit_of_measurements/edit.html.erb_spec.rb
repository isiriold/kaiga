...
describe "/inventory_unit_of_measurements/edit.html.erb" do
  ...
  it "renders the edit inventory_unit_of_measurements form" do
    render
    
    response.should have_tag("form[action=#{inventory_unit_of_measurements_path(@inventory_unit_of_measurements)}][method=post]") do
