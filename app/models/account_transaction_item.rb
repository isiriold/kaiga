class AccountTransactionItem < ActiveRecord::Base
  ...
  validates_presence_of :account_id, :category, :amount, :branch_id
  ...
  attr_accessible :account_id, :category, :amount  #TODO: must remove :account_id from attr_accessible list
  before_validation :set_account_balances
