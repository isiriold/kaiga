class AccountingDay < ActiveRecord::Base
  ...
  def set_accounting_period_column
    accounting_period = AccountingPeriod.current_accounting_period(branch, for_date)
  ...
  def create_account_balances
    ...
    last_accounting_day.account_balances.each do |account_balance|
      ...
      new_ab.accounting_period_id = AccountingPeriod.current_accounting_period(branch, for_date).id
